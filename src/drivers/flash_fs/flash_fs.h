 ...
 * @return Opaque directory handle on success, NULL on failure or if path is NULL.
 *
 ...
 * @return 0 on success, D_FS_ERR_INVAL if used or total is NULL or negative d_fs_err_t values on failure.
 */
 ...
 * @return true if the entry exists, false otherwise or if the path is NULL
 */
